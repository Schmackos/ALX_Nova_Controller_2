...
// ===== Firmware Version =====
#define FIRMWARE_VERSION "1.1.19"
...
const unsigned long BTN_MULTI_CLICK_WINDOW = 400;     // Time window for double/triple clicks
...
const unsigned long OTA_CHECK_INTERVAL = 300000;      // Check every 5 minutes (300000 ms)
