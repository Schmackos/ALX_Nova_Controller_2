...
/* ===== 03-components.css ===== */
        ...
        /* DSP summary line (click to expand drawer) */
        .channel-dsp-summary {
            display: flex;
            align-items: center;
            gap: 6px;
        ...
        .dsp-drawer-open .dsp-drawer-chevron {
            transform: rotate(180deg);
        }
        .channel-dsp-drawer {
            background: var(--bg-surface);
        ...
        .dsp-drawer-region:last-child {
            margin-bottom: 0;
        }
        .dsp-drawer-region-label {
            font-size: 10px;
            font-weight: 600;
            text-transform: uppercase;
            letter-spacing: 0.5px;
        ...
        .dsp-stage-item:active {
            cursor: grabbing;
        }
        .dsp-stage-item-label {
            flex: 1;
            overflow: hidden;
            text-overflow: ellipsis;
            white-space: nowrap;
        ...
        /* Corner cell — top-left: "INPUTS \ OUTPUTS" */
        .matrix-corner {
            font-size: 9px;
            font-weight: 600;
            color: var(--text-disabled);
        ...
        /* Device group header in column axis */
        .matrix-dev-hdr {
            font-size: 10px;
            font-weight: 700;
            color: var(--accent);
        ...
        /* Per-channel column label (L/R/Ch), rotated */
        .matrix-col-hdr {
            font-size: 10px;
            font-weight: 600;
            color: var(--text-secondary);
        ...
        /* Device group header in row axis (merged rows) */
        .matrix-row-dev-hdr {
            font-size: 9px;
            font-weight: 700;
            color: var(--accent);
        ...
        /* Import label styled as btn — wraps hidden file input */
        .peq-import-label {
            display: inline-flex;
            align-items: center;
            gap: 4px;
...
.channel-label[contenteditable="true"] {
    background: var(--bg-input);
...
<body class="has-status-bar">
    ...
    <main class="tab-content">
        ...
        <section id="devices" class="panel">
            ...
            <div id="i2s-ports-container"></div>
