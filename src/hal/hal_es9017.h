#pragma once
#ifdef DAC_ENABLED
// HalEs9017 — ESS ES9017 8-channel 32-bit DAC (HAL_DEV_DAC)
...
// Architecture: HyperStream IV, 120 dB DNR, PCM up to 768kHz.
// Pin-compatible with ES9027PRO — intended as a direct drop-in replacement.
...
//   sink index 0 -> "ES9017 CH1/2"  (SLOT0 + SLOT1)
//   sink index 1 -> "ES9017 CH3/4"  (SLOT2 + SLOT3)
//   sink index 2 -> "ES9017 CH5/6"  (SLOT4 + SLOT5)
//   sink index 3 -> "ES9017 CH7/8"  (SLOT6 + SLOT7)

#include "hal_ess_sabre_dac_base.h"
#include "hal_tdm_interleaver.h"

class HalEs9017 : public HalEssSabreDacBase {
public:
    HalEs9017();
    virtual ~HalEs9017() {}
