...
HalEs9823pro::HalEs9823pro() : HalEssSabreAdcBase() {
    hal_init_descriptor(_descriptor, "ess,es9823pro", "ES9823PRO", "ESS Technology",
...
HalInitResult HalEs9823pro::init() {
    ...
    // Note: ES9823PRO supports 0-42 dB — no additional gain clamp needed
