#pragma once
#ifdef DAC_ENABLED
// HalEs9842pro — ESS ES9842PRO 4-channel 32-bit ADC (HAL_DEV_ADC)
...
// Compatible string: "ess,es9842pro"
//
// TDM deinterleaver
// -----------------
// The ES9842PRO outputs all 4 channels on a single I2S DATA line in TDM mode:
...
//   source index 0 → "ES9842PRO CH1/2"  (SLOT0 + SLOT1)
//   source index 1 → "ES9842PRO CH3/4"  (SLOT2 + SLOT3)
//
...
class HalEs9842pro : public HalAudioDevice, public HalAudioAdcInterface {
public:
    HalEs9842pro();
    virtual ~HalEs9842pro() {}
...
private:
    ...
    uint8_t  _i2cAddr      = 0x40;   // ES9842PRO default
    ...
    static constexpr const char* _NAME_A = "ES9842PRO CH1/2";
    static constexpr const char* _NAME_B = "ES9842PRO CH3/4";
};
