#pragma once
#ifdef DAC_ENABLED
// HalEs9038pro — ESS ES9038PRO 8-channel 32-bit DAC (HAL_DEV_DAC)
...
// Architecture: HyperStream II, 132 dB DNR, PCM up to 768kHz, DSD512.
// Default I2C bus: Bus 2 (expansion), GPIO28 SDA / GPIO29 SCL.
// Compatible string: "ess,es9038pro"
//
// TDM interleaver
// ---------------
// The ES9038PRO accepts all 8 channels on a single TDM DATA line in 8-slot mode:
...
//   sink index 0 -> "ES9038PRO CH1/2"  (SLOT0 + SLOT1)
//   sink index 1 -> "ES9038PRO CH3/4"  (SLOT2 + SLOT3)
//   sink index 2 -> "ES9038PRO CH5/6"  (SLOT4 + SLOT5)
//   sink index 3 -> "ES9038PRO CH7/8"  (SLOT6 + SLOT7)

#include "hal_ess_sabre_dac_base.h"
#include "hal_tdm_interleaver.h"

class HalEs9038pro : public HalEssSabreDacBase {
public:
    HalEs9038pro();
    virtual ~HalEs9038pro() {}
