...
const CirrusDac2chDescriptor kDescCS43198 = {
    ...
    /* capabilities       */ (uint32_t)(HAL_CAP_DAC_PATH | HAL_CAP_HW_VOLUME | HAL_CAP_MUTE | HAL_CAP_FILTERS | HAL_CAP_DSD),
...
const CirrusDac2chDescriptor kDescCS43131 = {
    ...
    /* capabilities       */ (uint32_t)(HAL_CAP_DAC_PATH | HAL_CAP_HW_VOLUME | HAL_CAP_MUTE | HAL_CAP_FILTERS | HAL_CAP_DSD | HAL_CAP_HP_AMP),
    /* sampleRateMask     */ HAL_RATE_44K1 | HAL_RATE_48K | HAL_RATE_96K | HAL_RATE_192K | HAL_RATE_384K,
    /* supportedRates     */ kCirrusRates5,
    /* supportedRateCount */ 5,
...
const CirrusDac2chDescriptor kDescCS4399 = {
    ...
    /* capabilities       */ (uint32_t)(HAL_CAP_DAC_PATH | HAL_CAP_HW_VOLUME | HAL_CAP_MUTE | HAL_CAP_FILTERS),
    /* sampleRateMask     */ HAL_RATE_44K1 | HAL_RATE_48K | HAL_RATE_96K | HAL_RATE_192K | HAL_RATE_384K,
    /* supportedRates     */ kCirrusRates5,
    /* supportedRateCount */ 5,
