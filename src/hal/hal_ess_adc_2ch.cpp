...
const EssAdc2chDescriptor kDescES9822PRO = {
    ...
    /* altChipName         */ nullptr,
    /* capabilities        */ (uint16_t)(HAL_CAP_ADC_PATH | HAL_CAP_HW_VOLUME | HAL_CAP_PGA_CONTROL | HAL_CAP_HPF_CONTROL),
...
const EssAdc2chDescriptor kDescES9826 = {
    ...
    /* altCompatible       */ nullptr,
    /* altChipName         */ nullptr,
    /* capabilities        */ (uint16_t)(HAL_CAP_ADC_PATH | HAL_CAP_HW_VOLUME | HAL_CAP_PGA_CONTROL),
    /* sampleRateMask      */ HAL_RATE_44K1 | HAL_RATE_48K | HAL_RATE_96K | HAL_RATE_192K,
    /* supportedRates      */ kAdcRates4,
    /* supportedRateCount  */ 4,
...
const EssAdc2chDescriptor kDescES9821 = {
    ...
    /* altCompatible       */ nullptr,
    /* altChipName         */ nullptr,
    /* capabilities        */ (uint16_t)(HAL_CAP_ADC_PATH | HAL_CAP_HW_VOLUME),
    /* sampleRateMask      */ HAL_RATE_44K1 | HAL_RATE_48K | HAL_RATE_96K | HAL_RATE_192K,
    /* supportedRates      */ kAdcRates4,
    /* supportedRateCount  */ 4,
