...
const EssDac2chDescriptor kDescES9069Q = {
    ...
    /* capabilities      */ (uint32_t)(HAL_CAP_DAC_PATH | HAL_CAP_HW_VOLUME | HAL_CAP_FILTERS | HAL_CAP_MUTE | HAL_CAP_MQA | HAL_CAP_DPLL),
    /* sampleRateMask    */ HAL_RATE_44K1 | HAL_RATE_48K | HAL_RATE_96K | HAL_RATE_192K | HAL_RATE_384K | HAL_RATE_768K,
    /* supportedRates    */ kRates6,
    /* supportedRateCount*/ 6,
...
const EssDac2chDescriptor kDescES9033Q = {
    ...
    /* capabilities      */ (uint32_t)(HAL_CAP_DAC_PATH | HAL_CAP_HW_VOLUME | HAL_CAP_FILTERS | HAL_CAP_MUTE | HAL_CAP_LINE_DRIVER | HAL_CAP_DPLL),
    /* sampleRateMask    */ HAL_RATE_44K1 | HAL_RATE_48K | HAL_RATE_96K | HAL_RATE_192K | HAL_RATE_384K | HAL_RATE_768K,
    /* supportedRates    */ kRates6,
    /* supportedRateCount*/ 6,
...
const EssDac2chDescriptor kDescES9020Dac = {
    ...
    /* capabilities      */ (uint32_t)(HAL_CAP_DAC_PATH | HAL_CAP_HW_VOLUME | HAL_CAP_MUTE | HAL_CAP_FILTERS | HAL_CAP_APLL | HAL_CAP_DPLL),
