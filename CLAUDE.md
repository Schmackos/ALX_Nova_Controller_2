...
1. `cpp-tests` — `pio test -e native -v` (~2335 Unity tests across 91 modules)
...
- **HAL slot capacity**: 14/32 slots used at boot (`HAL_MAX_DEVICES=32`). Pin tracking: `HAL_MAX_PINS=56` with `HAL_GPIO_MAX=54` validation
