...
| Stage | Meaning |
|---|---|
| `draft` | Generated by pipeline, needs review and editing |
| `ready` | Reviewed, action items refined, ready for brainstorming |
| `in-progress` | Being actively worked on (PRD, plan, or execution) |
