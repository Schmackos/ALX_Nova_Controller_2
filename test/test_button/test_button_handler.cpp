...
enum ButtonEvent { NONE, SINGLE_CLICK, DOUBLE_CLICK, LONG_PRESS, VERY_LONG_PRESS };
...
int readButtonPin() {
    return TestButtonState::mockButtonPin[BUTTON_PIN];
}
