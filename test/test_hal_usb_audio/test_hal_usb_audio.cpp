...
//
// USB Audio is a software source — its AudioInputSource must report
// isHardwareAdc == false so the noise gate skips it.
// =====================================================================

void test_usb_audio_input_source_not_hardware_adc() {
    const AudioInputSource* src = dev->getInputSource();
    TEST_ASSERT_NOT_NULL(src);
...
int main(int argc, char** argv) {
    ...
    RUN_TEST(test_usb_audio_input_source_not_hardware_adc);
