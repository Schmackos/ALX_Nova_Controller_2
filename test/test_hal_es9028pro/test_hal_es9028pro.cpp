// test_hal_es9028pro.cpp
// Tests a mock HalEs9028pro class modelling the ESS ES9028PRO 8-channel I2C DAC.
//
// The ES9028PRO is ESS's 8-channel HyperStream II DAC:
//   - I2C address 0x48
...
// ===== Mock ES9028PRO 8-channel DAC =====

class HalEs9028ProMock : public HalAudioDevice, public HalAudioDacInterface {
public:
    ...
    HalEs9028ProMock() {
        ...
        strncpy(_descriptor.compatible, "ess,es9028pro", 31);
        strncpy(_descriptor.name, "ES9028PRO", 32);
    ...
    bool buildSinkAt(int idx, uint8_t sinkSlot, AudioOutputSink* out) override {
        ...
        static const char* names[4] = {
            "ES9028PRO CH1/2", "ES9028PRO CH3/4",
...
// ===== Fixtures =====
static HalEs9028ProMock* dac;

void setUp(void) {
    WireMock::reset();
    dac = new HalEs9028ProMock();
}
...
void test_descriptor_compatible_string(void) {
    TEST_ASSERT_EQUAL_STRING("ess,es9028pro", dac->getDescriptor().compatible);
}

void test_descriptor_name(void) {
    TEST_ASSERT_EQUAL_STRING("ES9028PRO", dac->getDescriptor().name);
}
